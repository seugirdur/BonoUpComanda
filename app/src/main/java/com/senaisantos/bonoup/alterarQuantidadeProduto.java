...
public class alterarQuantidadeProduto extends AppCompatActivity {
    ...
    private void atualizarItem(String ip){
        ...
        Ion.with(alterarQuantidadeProduto.this)
                .load(url)
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        try {
                            ...
                            if (RETORNO.equals("erro")) {
                                Toast.makeText(alterarQuantidadeProduto.this, "Erro ao atualizar item.", Toast.LENGTH_LONG).show();
                            } else {

                                Toast.makeText(alterarQuantidadeProduto.this, "Produto atualizado", Toast.LENGTH_SHORT).show();

                                finish();

                            }
                        } catch (Exception erro) {
                            Toast.makeText(alterarQuantidadeProduto.this, "Ocorreu um erro! Tente novamente mais tarde.", Toast.LENGTH_LONG).show();
                        }
                    }
                ...
                .setCallback(new FutureCallback<JsonObject>(){
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        try {
                            ...
                            if (RETORNO.equals("erro")) {
                                Toast.makeText(alterarQuantidadeProduto.this, "Erro ao adicionar item.", Toast.LENGTH_LONG).show();
                            } else {

//                                p.setId(result.get("idPedido").getAsInt());
                                ipe.setIdProduto(result.get("idItemPedido").getAsInt());

                                Toast.makeText(alterarQuantidadeProduto.this, "Produto adicionado", Toast.LENGTH_SHORT).show();

                                Intent i = new Intent(alterarQuantidadeProduto.this, alterarCategoria.class);
